<?php 
/**
 * Template Name: Solutions | Template 1
*/
get_header(); ?>
...
<section class="container-fluid case-sheets lightGray-bg wrap push">
	<div class="container case-sheets-wrapper">
		<h2 class="purple-text heading-2"><?php the_field('datasheet_header'); ?></h2>
		
		<?php if( have_rows('datasheet_repeater') ): ?>
			<?php while( have_rows('datasheet_repeater') ): the_row(); ?>
				<div class="col-md-4 col-sm-4 col-xs-12 case-box">
					<a href="#" target="_blank">
						<div class="case-box-wrapper hovereffect">
						<a href="<?php the_sub_field('datasheet_source'); ?>" target="_blank">
							<img src="<?php the_sub_field('datasheet_image'); ?>" class="ds-box-img" alt="">
							<h4 class="heading-4"><?php the_sub_field('datasheet_title'); ?></h4>
						</a>
						</div>
					</a>
				</div>	
		...
		<div class="solution-cs-btn-wrapper">
			<a href="<?php echo ROOT_URL; ?><?php the_field('datasheet_button_path'); ?>" class="btn btn-lg btn-green" target="_blank"><?php the_field('datasheet_button_title'); ?></a>
		</div>
...
<section class="container-fluid case-sheets-second lightGray-bg wrap push">
	<div class="container case-sheets-wrapper-second">
		<div class="solutions-cs-header">
			<h2 class="purple-text heading-2"><?php the_field('case_study_section_header'); ?></h2>	
		</div>
	...
	<?php if( have_rows('case_study_repeater') ): ?>
		...
		<div class="col-md-4 col-sm-4 col-xs-12 case-box">
			<div class="customer-logo client-box-pic box-shadow sol-fix">
				<a href="<?php echo ROOT_URL; ?><?php the_sub_field('case_study_source'); ?>" target="_blank">
					<img src="<?php the_sub_field('case_study_image'); ?>" class="customerLogo-img raq-logo-fix" alt=""><br>
					<div class="case-box-title">
						<h4 class="heading-4"><?php the_sub_field('case_study_title'); ?></h4>
					</div>
				</a>
			</div>
		</div><!-- case-box -->
	...
	<?php endif; ?>
		...
		<div class="solution-cs-btn-wrapper">
			<a href="<?php echo ROOT_URL; ?><?php the_field('case_study_button_path'); ?>" class="btn btn-lg btn-green" target="_blank"><?php the_field('case_study_button_title'); ?></a>
		</div>
	</div><!-- case-sheets-wrapper -->
</section><!-- case-sheets -->
...
<section class="container-fluid section-four wrap push">
	<div class="section-four-wrapper">
		...
		<div class="brag-time">
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/best-western.png" alt="Best Western" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/checkers.png" alt="Checkers and Rally's" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/chilies.png" alt="Chilies" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/cracker-barrel.png" alt="Cracker Barrel" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/dairy-queen.png" alt="Dairy Queen" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/firehouse-subs.png" alt="Firehouse Subs" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/friendlys.png" alt="Friendly's" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/ASI.png" alt="ASI" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/golden-corral.png" alt="Golden Corral" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/hard-rock.png" alt="Hard Rock" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/ihop.png" alt="IHop" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/longhorn-steakhouse.png" alt="Longhorn Steakhouse" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/macaroni-grill.png" alt="Macaroni Grill" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/mcdonalds.png" alt="Mcdonalds" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/olive-garden.png" alt="Olive Garden" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/papa-murphies.png" alt="Papa Murphy's" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/pollo-loco.png" alt="Pollo Loco" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/Chemstar.PNG" alt="Chemstar" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/sears.png" alt="Sears" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/starbucks.png" alt="Starbucks" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo visible"><img src="<?php echo ROOT; ?>assets/img/clients/staybrdige.png" alt="Stay Bridge" class="customerLogo-img"></div>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 customer-logo"><img src="<?php echo ROOT; ?>assets/img/clients/texas-roadhouse.png" alt="Texas Roadhouse" class="customerLogo-img"></div>
		</div>
		<div class="brag-btn-wrapper">
...
<section class="container-fluid green-bg wrap push">
	<div class="container raq-wrapper">
		<div class="col-md-6 col-sm-12 req-left">
			<div class="req-title">
				<h2 class="heading-2"><?php the_field('demo_section_header'); ?></h2>
				<div class="raq-form">
					<span class="raq-disclaimer"><?php the_field('demo_disclaimer'); ?></span>
