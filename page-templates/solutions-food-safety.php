<?php 
/**
 * Template Name: Solutions | Food Safety
*/
get_header(); ?>
...
<div class="container-fluid green-yellow">
	...
	<div class="container banner wrap push">
		<div class="banner-wrapper">
			<h1 class="heading-1">Food Safety</h1>
...
<section class="container-fluid solutions-section-one wrap push">
	<div class="container solutions-section-one-wrapper">
		<h2 class="pink-text heading-2">Enjoy Peace of Mind with RizePoint®, a Better System for Food Safety.</h2>
		<div class="persona-list">
			<div class="col-md-3 col-sm-6 col-xs-6 persona-wrapper personaBtn" id="persona-1">
				...
				<div class="persona-title">
					<h4 class="heading-4">Food Safety Director  </h4>
				</div><!-- persona-title -->
			</div><!-- persona-wrapper -->
			<div class="col-md-3 col-sm-6 col-xs-6 persona-wrapper personaBtn" id="persona-2">
				...
				<div class="persona-title">
					<h4 class="heading-4">Quality Assurance Executive </h4>
				</div><!-- persona-title -->
			</div><!-- persona-wrapper -->
			<div class="col-md-3 col-sm-6 col-xs-6 persona-wrapper personaBtn" id="persona-3">
				...
				<div class="persona-title">
					<h4 class="heading-4">Quality Analysis Manager</h4>
				</div><!-- persona-title -->
			</div><!-- persona-wrapper -->
			...
			<div class="persona-info-wrapper" id="persona-1-content">
				...
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-text">
					<h3 class="heading-3">Food Safety Director  </h3>
					<p>Give your team the tools they need to audit, correct, monitor, and report on adherence to food safety standards and regulations throughout your supply chain and all locations. With everyone on the same platform, you can reference the most up-to-date information to issue requirements manuals, compile audit and test results, and report on food safety activities. Protect customers and the company with a single mobile, cloud-based quality management solution.</p>
			...
			<div class="persona-info-wrapper" id="persona-3-content">
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-image">
					<img src="<?php echo ROOT; ?>assets/img/solutions/rizepoint-small-min-min.jpg
" class="persona-info-img" alt="">
				</div><!-- persona-info-image -->
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-text">
					<h3 class="heading-3">Quality Analysis Manager</h3>
					<p>Manage food safety requirements throughout your supply chain and all locations with RizePoint. Ensure your team is always working with the most up-to-date information, and keep track of all the moving parts in one easy platform. RizePoint lets you confidentially share manuals and guidelines, collect and store documents, schedule and conduct audits, and make quick corrections when issues are found.</p>
					<div class="persona-cta-btn">
						<a href="<?php echo ROOT_URL; ?>/request-a-demo" class="btn btn-lg btn-green">Request A Demo</a>
					</div><!-- persona-cta-btn -->
				</div><!-- persona-info-text -->
			...
			<div class="customer-logo client-box-pic box-shadow sol-fix">
				<a href="https://rizepoint.com/wp-content/uploads/2016/10/RizePoint-Case-Study-Wendys.pdf" target="_blank">
					...
					<div class="case-box-title">
						<h4 class="heading-4">Wendy's Case Study</h4>
					</div>
				</a>
			</div>
		</div><!-- case-box -->
