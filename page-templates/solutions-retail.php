<?php 
/**
 * Template Name: Solutions | Retail
*/
get_header(); ?>
...
<div class="container-fluid pink-yellow">
	...
	<div class="container banner wrap push">
		<div class="banner-wrapper">
			<h1 class="heading-1">Retail Operations</h1>
	...
	<div class="large-modal modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title heading-4" id="banner-videoLabel">How RizePoint Can Help Retail</h4>
			</div>
...
<section class="container-fluid solutions-section-one wrap push">
	<div class="container solutions-section-one-wrapper">
		<h2 class="pink-text heading-2">Perfect Your Customer Experience with RizePoint® </h2>
		<div class="persona-list">
			<div class="col-md-3 col-sm-6 col-xs-6 persona-wrapper personaBtn" id="persona-1">
				...
				<div class="persona-title">
					<h4 class="heading-4">Executive</h4>
				</div><!-- persona-title -->
			</div><!-- persona-wrapper -->
			<div class="col-md-3 col-sm-6 col-xs-6 persona-wrapper personaBtn" id="persona-2">
				...
				<div class="persona-title">
					<h4 class="heading-4">Director of Retail Operations</h4>
				</div><!-- persona-title -->
			</div><!-- persona-wrapper -->
			<div class="col-md-3 col-sm-6 col-xs-6 persona-wrapper personaBtn" id="persona-3">
				...
				<div class="persona-title">
					<h4 class="heading-4">Retail Operations Manager</h4>
				</div><!-- persona-title -->
			</div><!-- persona-wrapper -->
			...
			<div class="persona-info-wrapper" id="persona-1-content">
				...
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-text">
					<h3 class="heading-3">Executive</h3>
					<p>
			...
			<div class="persona-info-wrapper" id="persona-2-content">
				...
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-text">
					<h3 class="heading-3">Director of Retail Operations</h3>
					<p>
					Give your team the tools they need to audit, correct, and monitor standards and regulations in every location. By ensuring consistency and quality across the company, you manage threats to your brand reputation while driving customer loyalty. RizePoint’s management and mobile evaluation platform helps you execute operational processes perfectly in a hyper-competitive multiunit retail industry.
					</p>
					<div class="persona-cta-btn">
						<a href="<?php echo ROOT_URL; ?>/request-a-demo" class="btn btn-lg btn-green">Request A Demo</a>
					</div><!-- persona-cta-btn -->
			...
			<div class="persona-info-wrapper" id="persona-3-content">
				...
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-text">
					<h3 class="heading-3">Retail Operations Manager</h3>
					<p>
					Stop the ops management juggling act. RizePoint’s cloud-based management console gives you the tools to manage efficient, accurate audits to maintain standards for service, people, and product at every retail location. Simply push updated schedules and forms to auditors through their mobile auditing app. And corrective actions or last-minute reports are no problem with RizePoint’s intuitive platform that lets you automate corrections and create ad-hoc reports as fast as you can type.
					</p>
					<div class="persona-cta-btn">
						<a href="<?php echo ROOT_URL; ?>/request-a-demo" class="btn btn-lg btn-green">Request A Demo</a>
					</div><!-- persona-cta-btn -->
							...
							<div class="img-pointer sf-pointer-3"></div>
								<div class="feature-content">
									...
									<ul>
										...
										<li>Single Sign-On available for web and Mobile Auditor</li>
									</ul>
								</div><!-- home-box-feature-1 -->
							</div>
						</div><!-- container -->
