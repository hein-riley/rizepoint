<?php 
/**
 * Template Name: Solutions | Other-Industries
*/
get_header(); ?>
...
<div class="container-fluid green-blue-purple">
	...
	<div class="container banner wrap push">
		<div class="banner-wrapper">
			<h1 class="heading-1">Other Industries</h1>
	...
	<div class="large-modal modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title heading-4" id="banner-videoLabel">RizePoint Can Help Any Industry</h4>
			</div>
...
<section class="container-fluid solutions-section-one wrap push">
	<div class="container solutions-section-one-wrapper">
		<h2 class="pink-text heading-2">Your Unique Operations Made Smarter. </h2>
		<div class="persona-list">
			...
			<div class="col-md-3 col-sm-6 col-xs-6 persona-wrapper personaBtn" id="persona-2">
				...
				<div class="persona-title">
					<h4 class="heading-4">IT Professional</h4>
				</div><!-- persona-title -->
			</div><!-- persona-wrapper -->
			...
			<div class="persona-info-wrapper" id="persona-1-content">
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-image">
					<img src="<?php echo ROOT; ?>assets/img/solutions/rizepoint-modern825157-min-min.jpg
" class="persona-info-img" alt="">
				</div><!-- persona-info-image -->
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-text">
					<h3 class="heading-3">Operations Executive  </h3>
					<p>
					Drive strategy and continuous improvement for your operations. RizePoint® gives you complete visibility, with tools that go to the core of your business performance: data gathering, reporting, business intelligence, and corrective action. Dashboards highlight key information, and effortless search-driven analytics give you data that matters – enabling you to improve efficiency, customer experience, and safety.
					</p>
			...
			<div class="persona-info-wrapper" id="persona-2-content">
				...
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-text">
					<h3 class="heading-3">IT Professional</h3>
					<p>
					Unite the technology needs of operations, quality, and brand departments under one low-maintenance tool. With built-in business intelligence and automated corrective action tools, RizePoint is the software of choice for quality management. It’s also the smart choice for an IT department needing to provide aggregated data to the C-suite. With easy reporting and analytics, IT can spend less time tracking down information and more time delivering improved data sets.
					</p>
					<div class="persona-cta-btn">
						<a href="<?php echo ROOT_URL; ?>/request-a-demo" class="btn btn-lg btn-green">Request A Demo</a>
					</div><!-- persona-cta-btn -->
			...
			<div class="persona-info-wrapper" id="persona-3-content">
				...
				<div class="col-md-6 col-sm-12 col-xs-12 persona-info-text">
					...
					<p>
					Stop the ops management juggling act. RizePoint’s cloud-based management console gives you the tools to manage efficient, accurate audits in every location. Simply push updated schedules and forms to auditors through their mobile auditing app. And corrective actions or last-minute reports are no problem with RizePoint’s intuitive platform that lets you automate corrections and create ad-hoc reports as fast as you can type.
					</p>
					<div class="persona-cta-btn">
						<a href="<?php echo ROOT_URL; ?>/request-a-demo" class="btn btn-lg btn-green">Request A Demo</a>
					</div><!-- persona-cta-btn -->
			...
			<div class="slant-content-wrap">
				<div class="system-features solutions-system-features">
					<div class="container system-features-wrapper">
						<h2 class="heading-2">System Features for Other Industries</h2>
					...
					<div class="container system-features-wrapper">
						...
						<div class="col-lg-4 col-sm-6 col-xs-12 box-feature-wrapper" role="button" data-toggle="collapse" href="#home-box-feature-5" aria-expanded="false" aria-controls="collapseExample">
							<div class="box-feature" style="background-image: url(<?php echo ROOT; ?>assets/img/home/Role-Based-Access_RizePoint-min.PNG)
"></div><!-- box-feature -->
							<div class="box-feature-header">
...
<section class="container-fluid case-sheets-second lightGray-bg wrap push">
	<div class="container case-sheets-wrapper-second">
		...
		<div class="col-md-4 col-sm-4 col-xs-12 case-box">
			<div class="customer-logo client-box-pic box-shadow sol-fix">
				<a href="https://rizepoint.com/wp-content/uploads/2016/10/RizePoint-Case-Study-Checkers.pdf" target="_blank">
					...
					<div class="case-box-title">
					<h4 class="heading-4">Checker's Case Study</h4>
					</div>
				</a>
			</div>
		</div><!-- case-box -->
		<div class="col-md-4 col-sm-4 col-xs-12 case-box">
			<div class="customer-logo client-box-pic box-shadow sol-fix">
				<a href="https://rizepoint.com/hard-rock-case-study" target="_blank">
					<img src="<?php echo ROOT; ?>/assets/img/clients/hard-rock.png" class="customerLogo-img raq-logo-fix" alt=""><br>
					<div class="case-box-title">
					<h4 class="heading-4">Hard Rock Hotel Case Study</h4>
					</div>
				</a>
			</div>
		</div><!-- case-box -->
