	...
	<div class="aud-wrapper">
		<div class="row">
			...
			<div class="col-md-7 col-sm-6 col-xs-12 aud-text">
				...
				<h3 class="heading-3">Inspect every location efficiently using a proven, time-tested mobile audit app.</h3>
				<ul>
					<li>Perform audits using smartphones, tablets, or web browser</li>
					<li>Go anywhere with offline access</li>
					<li>Conduct temperature checks with thermocouple device integration</li>
		...
		<div class="row">
			...
			<div class="col-md-7 col-sm-6 col-xs-12 man-text">
				...
				<ul>
					...
					<li>Schedule inspections and view group schedules</li>
	...
	<div class="man-wrapper">
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 man-text2">
				...
				<ul>
					<li>Define corrective action plan and approval processes</li>
		...
		<div class="row">
			...
			<div class="col-md-7 col-sm-6 col-xs-12 man-text">
				...
				<ul>
					...
					<li>Use pre-built management dashboards to view top-level details and drill into specifics</li>
					<li>Create ad-hoc reports with search-driven analytics</li>
	...
	<div class="man-wrapper">
		<div class="row">
			<div class="col-md-7 col-sm-6 col-xs-12 man-text2">
				...
				<ul>
					<li>Define onboarding tasks to be completed</li>
	...
	<div class="man-wrapper">
		<div class="row">
			...
			<div class="col-md-7 col-sm-6 col-xs-12 man-text">
				...
				<h3 class="heading-3">Get everything you want in one complete quality management software.</h3>
				<ul>
					<li>Set role-based permissions so your users see only what they need</li>
					<li>Share key details using automated communication tools</li>
					<li>Configure RizePoint to match your organizational set-up</li>
					<li>Sync your data using the RizePoint API framework</li>
				</ul>
				<div class="products-video-btn">
					<a class="btn btn-md btn-green" data-toggle="modal" data-target="#mc-three">View Video</a>
					<a href="<?php echo ROOT; ?>/assets/docs/datasheets/business-intelligence-june-2017.pdf" target="_blank" class="btn btn-md btn-green">Learn More</a>
