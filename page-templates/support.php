...
<div class="container-fluid green-blue-purple">
	...
	<div class="container banner wrap push">
		<div class="home-banner-wrapper">
			<h1 class="heading-1">Expertise and tools to help you get peak performance and optimal value from your RizePoint solution.</h1>
...
<div class="container-fluid support-sub wrap push">
	<div class="container">
			...
			<h2 class="green-text heading-2">Welcome to RizePoint Support</h2>
			...
			<div class="content-1">
				<h3 class="heading-3">Managed Services</h3>
			...
			<div class="content-1">
				<h3 class="heading-3">Support Desk Services</h3>
			...
			<div class="content-1">
				<h3 class="heading-3">Additional Services</h3>
				...
				<div class="content-1">
				<h3 class="heading-3">Configuration Enhancement Services</h3>
  ...
  <section class="container engage-wrapper">
    <h2 class="heading-2">Register for Engage</h2>
    <h4 class="heading-4">February 6-8, 2018</h4>
